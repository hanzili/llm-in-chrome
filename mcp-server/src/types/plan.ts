...
export type StepAction =
  ...
  | "authenticate"  // Handle login/auth flow
...
export type TaskType =
  ...
  | "booking"         // Book appointment/flight/etc
  | "data_extract"    // Extract data from page
  | "navigation"      // Navigate to specific page
  | "file_upload"     // Upload a file
  | "file_download"   // Download a file
  | "account_action"  // Account-related action
  | "content_create"  // Create content (post, comment)
  | "custom";         // Other

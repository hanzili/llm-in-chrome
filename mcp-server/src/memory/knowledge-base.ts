 ...
 */
function getKnowledgePath(domain: string): string {
 ...
 * }
 */
export async function getKnowledge(domain: string): Promise<SiteKnowledge | null> {
 ...
 */
export async function lookupKnowledge(domain: string): Promise<KnowledgeLookupResult> {
 ...
 * `);
 */
export async function saveKnowledge(domain: string, content: string): Promise<void> {
 ...
 * `);
 */
export async function appendKnowledge(domain: string, newContent: string): Promise<void> {
  await ensureKnowledgeDir();
 ...
 */
export async function deleteKnowledge(domain: string): Promise<boolean> {
  const filePath = getKnowledgePath(domain);
 ...
 */
export async function hasKnowledge(domain: string): Promise<boolean> {
  const filePath = getKnowledgePath(domain);
 ...
 */
export async function getKnowledgeContent(domain: string): Promise<string> {
  const knowledge = await getKnowledge(domain);
